import{_ as s,c as n,o as a,V as l}from"./chunks/framework.031712c0.js";const p="/vp-blog/assets/08.952803ad.gif",d=JSON.parse('{"title":"Flutter 与 iOS 通信：MethodChannel","description":"","frontmatter":{"title":"Flutter 与 iOS 通信：MethodChannel","date":"2023-04-23T10:38:44.000Z","tags":["Flutter","iOS","Swift"],"layout":"post"},"headers":[],"relativePath":"docs/Flutter-与-iOS-通信：MethodChannel.md","filePath":"docs/Flutter-与-iOS-通信：MethodChannel.md","lastUpdated":1683622580000}'),e={name:"docs/Flutter-与-iOS-通信：MethodChannel.md"},o=l(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>之前分享了 <code>BasicMessageChannel</code>，看了官网了解到，它其实是最基础的一种方式，支持自定义消息的编解码器进行基本的异步消息传输。</p><p>一般的，我们使用 <code>MethodChannel</code>，也能达到 Flutter 请求调用原生方法，原生返回调用结果给 Flutter 的目的。</p><p>不得不说，Flutter 官网文档的例子十分地清楚，我从网站上跟随它的获取电池电量的例子，一次就成功了，下面就贴出代码，简单了解一下它的使用方式。</p><h2 id="代码" tabindex="-1">代码 <a class="header-anchor" href="#代码" aria-label="Permalink to &quot;代码&quot;">​</a></h2><p>创建 channel 的方式几乎和之前没有任何区别。通过 <code>channel.invoke(xxx)</code> 即可调用原生方法。</p><div class="language-flutter"><button title="Copy Code" class="copy"></button><span class="lang">flutter</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">import &#39;package:flutter/material.dart&#39;;</span></span>
